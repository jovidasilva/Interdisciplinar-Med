...
CREATE TABLE IF NOT EXISTS `proj_internato`.`alunos_subgrupos` (
  ...
  INDEX `idsubgrupo` (`idsubgrupo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `proj_internato`.`modulos` (
  ...
  INDEX `fk_modulos_departamentos` (`iddepartamento` ASC) ,
...
CREATE TABLE IF NOT EXISTS `proj_internato`.`avaliacoes_respostas` (
  ...
  INDEX `fk_resposta_avaliacao` (`idavaliacao` ASC) ,
  INDEX `fk_resposta_pergunta` (`idpergunta` ASC) ,
...
CREATE TABLE IF NOT EXISTS `proj_internato`.`horarios` (
  ...
  INDEX `fk_horarios_unidade_idx` (`idunidade` ASC) ,
  INDEX `fk_horarios_modulo_idx` (`idmodulo` ASC) ,
  INDEX `fk_horarios_preceptor_idx` (`idpreceptor` ASC) ,
  INDEX `fk_horario_subgrupo` (`idsubgrupo` ASC) ,
  INDEX `fk_horarios_departamento` (`iddepartamento` ASC) ,
...
CREATE TABLE IF NOT EXISTS `proj_internato`.`horarios_supervisao` (
  ...
  PRIMARY KEY (`idhorario`),
  INDEX `idpreceptor` (`idpreceptor` ASC) ,
  INDEX `idmodulo` (`idmodulo` ASC) ,
  INDEX `idunidade` (`idunidade` ASC) ,
